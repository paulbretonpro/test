import{b as x,x as E}from"./nqd95jrf.js";import{_ as N}from"./stacktrace-list.vue-dd1o2nt8.js";import{k as y,l as v,S as l,a0 as C,$ as S,U as f,a5 as p,W as _,M as w,Q as i,a6 as $}from"./vendor/json-editor-vue-fw81xiot.js";import"./vendor/unocss-dypm4cev.js";import"./vendor/shiki-j4jbxo4i.js";import"./filepath-item.vue-dhlc2m5d.js";const O=/(^|@)\S+:\d+/,h=/^\s*at .*(\S+:\d+|\(native\))/m,R=/^(eval@)?(\[native code\])?$/;function b(e,a){if(typeof e.stacktrace<"u"||typeof e["opera#sourceloc"]<"u")return V(e);if(e.stack&&e.stack.match(h))return F(e);if(e.stack)return A(e);throw new Error("Cannot parse given Error object")}function m(e){if(!e.includes(":"))return[e,void 0,void 0];const o=/(.+?)(?::(\d+))?(?::(\d+))?$/.exec(e.replace(/[()]/g,""));return[o[1],o[2]||void 0,o[3]||void 0]}function d(e,a){return e}function F(e,a){return I(e.stack)}function I(e,a){return d(e.split(`
...
`).filter(t=>!!t.match(O)&&!t.match(/^Error created at/))).map(t=>{const r=t.split("@"),n=m(r.pop()),c=r.shift()||"",s=c.replace(/<anonymous function(: (\w+))?>/,"$2").replace(/\([^)]*\)/g,"")||void 0;let u;c.match(/\(([^)]*)\)/)&&(u=c.replace(/^[^(]+\(([^)]*)\)$/,"$1"));const k=u===void 0||u==="[arguments not available]"?void 0:u.split(",");return{function:s,args:k,file:n[0],line:n[1]?+n[1]:void 0,col:n[2]?+n[2]:void 0,raw:t}})}function M(e){return e.map(a=>({functionName:a.function,args:a.args,fileName:a.file,lineNumber:a.line,columnNumber:a.col,source:a.raw}))}function g(e,a){return M(b(e))}const X={p6:""},D={key:0},G={"text-6xl":""},K={key:0,op75:""},U={my4:"","text-xl":"","text-red":""},W={key:1,"of-auto":"",rounded:"","bg-active":"",p2:""},j=["textContent"],z={key:1,op50:""},ee=y({__name:"error",setup(e){const a=x(),o=v(()=>{const r=a.value?.nuxt?.payload?.error;return r&&(console.error("[Nuxt DevTools] Error in payload:"),console.error(r),console.error({...r})),r}),t=v(()=>{if(!o.value?.stack)return[];try{return o.value.stack.startsWith("<pre>")?g({stack:o.value.stack.replace(/<.*?>/g,"")}):g(o.value)}catch(r){return console.error(r),[]}});return(r,n)=>{const c=E,s=N;return i(),l("div",X,[o.value?(i(),l("div",D,[C(c,{n:"red",icon:"i-carbon-warning-alt-filled",mb5:""},{default:S(()=>n[0]||(n[0]=[$(" Error occurred in this page ")])),_:1}),f("div",G,p(o.value.statusCode||"Client Error"),1),o.value.statusMessage?(i(),l("div",K,p(o.value.statusMessage),1)):_("",!0),f("div",U,p(o.value.message||o.value.description||"Unknown error"),1),t.value.length||o.value.stack?(i(),l("div",W,[n[1]||(n[1]=f("div",{px1:"",op50:""}," Stacktrace ",-1)),t.value.length?(i(),w(s,{key:0,px2:"",stacktrace:t.value},null,8,["stacktrace"])):(i(),l("pre",{key:1,textContent:p(o.value.stack)},null,8,j))])):_("",!0)])):(i(),l("div",z," No error "))])}}});export{ee as default};
